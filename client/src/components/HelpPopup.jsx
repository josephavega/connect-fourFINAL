...
import Help1 from "../../../public/help/Help_PlacingChip.gif";
import Help2 from "../../../public/help/Help_WinDiag.gif";
import Help3 from "../../../public/help/Help_Lightning.gif";
import Help4 from "../../..//public/help/Help_WinHoz.gif";
      ...
      <div className="help-popup">
        <div className="popup-header2">
          ...
          <button className="close-btn" onClick={onClose}>
            <img src="/Menu/Buttons/Help_Settings_Exit.png" alt="" />
          </button>
        </div>
